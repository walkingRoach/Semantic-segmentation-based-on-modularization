...
from models import SeqLane


if __name__ == '__main__':
    # test own model
    # model = getattr(vgg, 'vgg16_bn')(pretrained=False, remove_fc=True)
    ...
    # model = getattr(resnet, 'resnet18')(pretrained=False, remove_fc=True, deep_base=False)  # resnet18有66层
